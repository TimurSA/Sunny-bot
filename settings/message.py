...
специально для учебной деятельности.

Sunny shop является макетом онлайн магазина с эмуляцией оформления заказа с использованием базы данных.

Любите своих котов и кошек! 
""".format(KEYBOARD['OWL'])
